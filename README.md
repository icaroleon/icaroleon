<p align="right">
  ...
  <div>
    <p align="justify"> Formado em Direito e nascido em Minas Gerais, atuei como advogado criminalista desde a minha formação, em 2019. Após diversos projetos voluntários realizados e ter feito parte de escritórios tanto em Minas Gerais quanto no Rio de Janeiro, em 2022 dei voz à minha antiga paixão pela tecnologia, concluindo o Bootcamp de Web Development da Le Wagon, momento no qual tive contato com diversos conceitos, funcionalidades, linguagens (com enfoque em Ruby on Rails) e desafios dessa nova área. </p>
    <p align="justify"> Para complementar e aprofundar ainda mais os estudos, iniciei uma nova graduação em Análise e Desenvolvimento de Sistemas. Recentemente, tive contato com o ambiente Salesforce e suas diversas possibilidades. Neste momento, procuro uma oportunidade profissional para atuar em um ambiente de criação de produtos digitais. </p>
